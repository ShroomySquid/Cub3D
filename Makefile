...
#    Updated: 2024/03/15 09:59:23 by fbarrett         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MY_FILES	=	collision.c main.c check_map.c render_minimap.c error_msg.c check_textures.c render.c render2.c cube_utils.c parsing_map.c check_FC.c key_hooks.c minimap.c player.c	check_cardinals.c
