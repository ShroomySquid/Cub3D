...
#    Updated: 2024/03/07 10:53:51 by fbarrett         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MY_FILES	=	main.c check_map.c render_minimap.c error_msg.c	check_textures.c render.c	cube_utils.c	parsing_map.c	check_FC.c
